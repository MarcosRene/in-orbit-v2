...
import { authenticateFromGithubCode } from './authenticante-from-github-code'
...
describe('Authenticate From Github Code', () => {
  ...
  it('should be able to authenticate from github code', async () => {
    vi.spyOn(githubOauth, 'getUserFromAccessToken').mockResolvedValueOnce({
      ...
      name: 'John Doe',
      email: null,
      avatar_url: 'https://github.com/MarcosRene.png',
    })
  ...
  it('should be able to authenticate when if existing github user', async () => {
